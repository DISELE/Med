	...
	dA[x++] = "00001126 1950 Laurence Marshall, a former president of Raytheon, took his family to the bush land of the Kalahari Desert in South Africa where they encountered the native Bushmen. The area later became the border of Namibia and Botswana. In 2006 his daughter Elizabeth Marshall Thomas authored ”The Old Way: A Story of the First People.”(SSFC, 11/5/06, p.M3)";
	dA[x++] = "00001120 Valentine's day";
	...
	function dispCal(yy,mm) 
	{
		...
		var hilite_start = '<td width="100" style="background:' + todaybg + '" align="center"><b>'; 
		var td_start = '<td width="100" align="center">'; 
		...
		cal += '<table border="0" cellspacing="0" cellpadding="2" width="210"><tr><td><a href="#" onclick="if (cala = dispCal('+yb+','+mm+')) {document.getElementById(\'cal\').innerHTML = cala; return false;}"><<</a></td><td><a href="#" onclick="if (cala = dispCal('+yyb+','+mmb+')) {document.getElementById(\'cal\').innerHTML = cala; return false;}"><</a></td><td align="center"><a href="#" onclick="if (cala = dispCal('+yya+','+mma+')) {document.getElementById(\'cal\').innerHTML = cala; return false;}">></a></td><td align="center"><a href="#" onclick="if (cala = dispCal('+ya+','+mm+')) {document.getElementById(\'cal\').innerHTML = cala; return false;}">>></a></td></tr></table>';
		} else {cal += '<div> </div>';} 
		cal += '</div>'; 
		return cal;
		}
		
	function start() {var x = '<div id="calDate" ><\/div>'; var y = ''; if (tb == 't') y = x; else y =  x; document.getElementById('calendar').innerHTML = y; ev();}
	...
	function ev() {var ct = nextDate(selDate);var ct = nextDate(selDate);if (ct == '') ct = nextDate('0000' + selDate.substr(4));if (ct == '') ct = noMessage; document.getElementById('calDate').innerHTML = '<br \/> ' +ct;}